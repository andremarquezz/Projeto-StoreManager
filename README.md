...
<p>A API RESTful é um sistema de gerenciamento de vendas no formato dropshipping em que é possível criar, visualizar, atualizar, deletar produtos e vendas, construido dentro de containers dockerr utilizando um banco de dados MySQL</p>
